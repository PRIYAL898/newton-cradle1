...
function setup() {
	...
	chain2=new Chain(bob2.body,roof.body,240,0);
	chain3=new Chain(bob3.body,roof.body,360,0);
	chain4=new Chain(bob4.body,roof.body,480,0);
	chain5=new Chain(bob5.body,roof.body,600,0);
